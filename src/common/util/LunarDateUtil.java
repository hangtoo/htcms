...
public class LunarDateUtil {
	...
	public static String solarTolunar(String shortdate) {
		LunarDateUtil util=new LunarDateUtil(DateUtil.convertShortStringToDate(shortdate));
		return DateUtil.DateToStr(util.getDate());
	}

	public static Date solarTolunar(Date shortdate) {
		LunarDateUtil util=new LunarDateUtil(shortdate);
		return util.getDate();
	}
}