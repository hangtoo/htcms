...
import common.component.cms.action.ContentAction;
...
public class ContentActionTest extends BaseStrutsTestCase{

	public ContentActionTest(String name) {
		super(name);
	}

	@Test
	public void testNewOne() throws Exception{
		ContentAction action = createAction(ContentAction.class, "/cms","content_newOne");
	...
	public void testEdit() throws Exception{
		ContentAction action = createAction(ContentAction.class, "/cms","content_edit");
	...
	public void testSave() throws Exception{
		ContentAction action = createAction(ContentAction.class, "/cms","contentdb_save");
	...
	public void testDelete() throws Exception {
		ContentAction action = createAction(ContentAction.class, "/cms","contentdb_delete");
		//save a record
		action.newOne();
	...
	public void testUpdate() throws Exception {
		ContentAction action = createAction(ContentAction.class, "/cms","contentdb_update");
	...
	public void testSearch()  throws Exception{
		ContentAction action = createAction(ContentAction.class, "/cms","content_search");
