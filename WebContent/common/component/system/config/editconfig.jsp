...
<s:form action="configdb_update" >
	<s:hidden key="bean.id"/>
	<s:textfield key="bean.configkey" required="true" readonly="true"  requiredposition="right"  size="5"/>
    <s:textfield key="bean.configvalue" required="true" size="5"/>
