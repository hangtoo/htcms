...
function dragMoveDiv()
{
    ...
    this.Move_OnlyMove = function(Id,Evt)
    {
        ...
        document.onmouseup = function()
        {
            ...
            var l = o1.offsetLeft;
            var t = o1.offsetTop;   
            dragMoveDiv.Move_e(Id, l0 , t0, l, t);
    ...
    this.Move_e = function(Id, l0 , t0, l, t)
    {
        ...
        if (Math.abs(t + st - t0) < 2)
            ...
            o.style.top = t + st +"px";
        window["ct"+ Id] = window.setTimeout("dragMoveDiv.Move_e('"+ Id +"', "+ l0 +" , "+ t0 +", "+ (l + sl) +", "+ (t + st) +")", 1);
    }
}

var dragMoveDiv = new dragMoveDiv();
