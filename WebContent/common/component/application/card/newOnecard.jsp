...
<s:form action="carddb_save" >
	<s:hidden key="bean.id"/>
	<s:textfield key="bean.name" required="true" readonly="false"  requiredposition="right"  size="5"/>
    <s:textfield key="bean.no" required="true" size="5"/>
    
	<s:textfield key="bean.off" required="true" size="5"/>
	

	<s:textfield key="bean.desc" required="true" size="5"/><s:submit key="submit"/>
</s:form>
