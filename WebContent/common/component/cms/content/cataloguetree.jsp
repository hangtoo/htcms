...
<div class="operate_left">
	<p><a href="javascript: catalogtree.openAll();">全部展开</a> | <a href="javascript: catalogtree.closeAll();">全部关闭</a> | <a href="javascript: newcontent();">新增</a>
		...
		function newcontent(){
			window.location.href="<%=request.getContextPath()%>/cms/content_newOne.action?bean.catalogue.id=<s:property value="bean.catalogue.id"/>";
		}
		//-->
	</script>
	</p>
